<?php
/**
 * XML-Classname implementiert das Interface Element. Der im Parameter vom Konstruktor uebergebene Wert wird
...
class XMLClassname implements Element {
    ...
    /**
     * Die Classname-Elemente werden in XML-Form zurueckgegeben.
     * @return string Classname-Elemente in XML-Form
     */
