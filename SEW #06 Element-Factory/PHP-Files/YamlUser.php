<?php
/**
 * Yaml-User implementiert das Interface Element. Der im Parameter vom Konstruktor uebergebene Wert wird
...
class YamlUser implements Element {
    ...
    /**
     * Die User-Elemente werden in Yaml-Form zurueckgegeben.
     * @return string User-Elemente in Yaml-Form
     */
