<?php
/**
 * XML-Adapter implementiert das Interface Element. Der im Parameter vom Konstruktor uebergebene Wert wird
...
class XMLAdapter implements Element {
    ...
    /**
     * Die Adapter-Elemente werden in XML-Form zurueckgegeben.
     * @return string Adapter-Elemente in XML-Form
     */
